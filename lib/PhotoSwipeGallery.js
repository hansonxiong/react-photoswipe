...
var _reactComponentWrapper = (0, _reactTransformHmr3['default'])({
  filename: '/Users/hanson.xiong/Project/samples/react-photoswipe/src/PhotoSwipeGallery.js',
...
var PhotoSwipeGallery = (function (_React$Component) {
  ...
  function PhotoSwipeGallery() {
    ...
    _classCallCheck(this, _PhotoSwipeGallery);

    _get(Object.getPrototypeOf(_PhotoSwipeGallery.prototype), 'constructor', this).apply(this, arguments);
  ...
  var _PhotoSwipeGallery = PhotoSwipeGallery;
  PhotoSwipeGallery = _wrapComponent('_$PhotoSwipeGallery')(PhotoSwipeGallery) || PhotoSwipeGallery;
